...
<tr >
 ...
 <div id="welcome" style="border-right:#666666 1px dotted;"><h1>BILL PAYMENT</h1><br>
 ...
 %></div>
 <form name=F1 onSubmit="return check_form(this)" action="paybills_res.jsp" >
 <table cellspacing="5" cellpadding="3">
 <tr><td>ACCOUNT NO:</td><td> <input type="text" name="accountno"/></td></tr>
 <tr><td>USER NAME:</td><td> <input type="text" name="username"/></td></tr>
 <tr><td>PASSWORD:</td><td> <input type="password"
name="password"/></td></tr>
 <tr><td>Select Biller</td><td>
 <select name="biller" id="biller"><option value="">--- Select ---
</option>
 <%
 Connection con=GetCon.getCon();
 String cattype = "B";
 PreparedStatement ps=con.prepareStatement("Select * from NEWACCOUNT where category='B'");
