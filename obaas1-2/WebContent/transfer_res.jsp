...
PreparedStatement ps3=con3.prepareStatement("update NEWACCOUNT set amount=? where accountno='"+taccountno+"'");
 ...
 { 
out.println("Your request to transfer $" + accoun + " has been successfully paid.Your new account balance is");
...
request.setAttribute("balance","Insufficient amount in your account. Requested amount can not be transferred!!!");
 %>
 <jsp:forward page="transfer_req.jsp"></jsp:forward>
 <%
